...
if __name__ == "__main__":
    ...
    parser.add_argument('-n', '--exp-name', default="ATN-10-Neighbors", help='Manually set experiment name')
    parser.add_argument(
    ...
    train_dataset = MultiviewData_TNet_online(train=True, transform=transform, allow_close_neigh=True)
    valid_dataset = MultiviewData_TNet_online(train=False, transform=transform, allow_close_neigh=True)
    # Set up optimization
