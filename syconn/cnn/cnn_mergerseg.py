...
if __name__ == "__main__":
    ...
    base_dir = '/wholebrain/u/yliu/merger_gt_semseg_v10_2'

    # num_workers must be <=1 for MultiviewDataCached class
    train_dataset = MultiviewDataCached(base_dir=base_dir + '',
                                        train=True, inp_key='raw', target_key='label',
                                        transform=transform, num_read_limit=args.num_repeat)
    valid_dataset = MultiviewDataCached(base_dir=base_dir + '',
