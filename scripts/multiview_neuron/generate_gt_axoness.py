...
def GT_generation(kzip_paths, ssd_version, gt_type, nb_views, dest_dir=None,
    ...
    params = [(p, ssd_version, gt_type, n_voting, nb_views, ws, comp_window) for p in kzip_paths]
...
def gt_generation_helper(args):
    kzip_path, ssd_version, gt_type, n_voting, nb_views, ws, comp_window = args
