...
# paths
filtered_cs_ids_path = os.path.expanduser(f'/wholebrain/scratch/amancu/mergeError/Nodes/filtered_cs_ids[10k-100k]_glia.npy')
lookup_cellpair2cs_path = os.path.expanduser(
    f'/wholebrain/scratch/amancu/mergeError/Nodes/lookup_cellpair2cs[10k-100k]_glia.pkl')
...
if __name__ == '__main__':
    ...
    # with open(glia_path) as csv_file:
    #     csv_reader = csv.reader(csv_file, delimiter=',')
    #     glia_count = 0
    #     for row in csv_reader:
    #         if row[1] == 'ASTRO':
    #             glia_ids.append(int(row[0]))
    #             glia_count += 1
    ...
    # oligodend = 1284891076
    # glia_ids.append(oligodend)
    # glia_count += 1
    print(f'glia count: {len(glia_ids)}')

    # print(f'cell ids: {glia_ids}')
