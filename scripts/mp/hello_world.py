...
# get example arguments for our jobs (40 arrays of size 10)
params = np.arange(400).reshape((-1, 10))
# Create a list of arguments; each element is input for an executed script.
# We have created 20 jobs, each with 2 arrays
params = chunkify(params, 20)
