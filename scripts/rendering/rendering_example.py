...
if __name__ == "__main__":
    ...
    imwrite("/u/shum/labels0.png", label_views[0, 0])
    raise()
    imwrite("/u/shum/raw0.png", raw_views[0, 0, ..., ])
    remapped_label_views = remap_rgb_view(label_views)
    imwrite ("/u/shum/rmlabels0.png", remapped_label_views[0, 0])

#print(render.shape)

# (3, 2048, 2048, 3), (number views, x, y, number channels RGB)
# from imageio import imwrite
#imwrite("/u/shum/test4.png", render[2])
